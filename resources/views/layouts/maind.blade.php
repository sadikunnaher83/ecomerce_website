            ...
            <div class="col-lg-4 col-sm-12 col-xs-12">
              ...
              <div class="card mt-4 sm-mt-3">
                <div class="card-body">
                  ...
                  <div class="media">
                    <img
                      src="{{ asset("static/img/products/P009.png ") }}"
                      height="50px"
                      width="50px"
                      alt=""
                    />
                  ...
                  <div class="media">
                    <img
                      src="{{ asset("static/img/products/P002.png ") }}"
                      height="50px"
                      width="50px"
                      alt=""
                    />
                  ...
                  <div class="media">
                    <img
                      src="{{ asset("static/img/products/P004.png") }}"
                      height="50px"
                      width="50px"
                      alt=""
                    />
              ...
              <div class="card mt-4 sm-mt-3">
                <div class="card-body">
                  ...
                  <div class="media py-2 my-2">
                    <img
                      src="{{ asset("static/img/profile/profile-1.jpg") }}"
                  ...
                  <div class="media py-2 my-2">
                    <img
                      src="{{ asset("static/img/profile/profile-2.jpg") }}"
                      class="rounded-circle me-3"
                      height="45px"
                      width="45px"
                      alt=""
                  ...
                  <div class="media py-2 my-2">
                    <img
                      src="{{ asset("static/img/profile/profile-3.jpg") }}"
                      class="rounded-circle me-3"
                      height="45px"
                      width="45px"
                      alt=""
                  ...
                  <div class="media py-2 my-2">
                    <img
                      src="{{ asset("static/img/profile/profile-4.jpg") }}"
                      class="rounded-circle me-3"
                      height="45px"
                      width="45px"
                      alt=""
                  ...
                  <div class="media py-2 my-2">
                    <img
                      src="{{ asset("static/img/profile/profile-5.jpg") }}"
                      class="rounded-circle me-3"
                      height="45px"
                      width="45px"
                      alt=""
